...
<body ng-controller="StockController">
    ...
    <div class="container-fluid px-4 mb-5">
        <div class="row app-window mx-2">
            <div class="window-header">SAMPLE MATERIAL STOCK</div>
                                    ...
                                    <table class="table table-bordered table-sm table-striped mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 25%;">Quantity (Qtls)</th>
                                                <th style="width: 25%;">Volume (HL)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr ng-repeat="item in stockList">
                                                ...
                                                <td>
                                                    <input type="number" step="0.01" 
                                                           ...
                                                           placeholder="{{ item.materialName.includes('Volume') ? 'N/A' : '0.00' }}">
                                                </td>
                                                <td>
                                                    <input type="number" step="0.01" class="form-control form-control-sm bg-transparent border-0" ng-model="item.volume" placeholder="0.00">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>

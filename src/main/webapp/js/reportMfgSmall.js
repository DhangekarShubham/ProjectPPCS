var app = angular.module('mfgSmallApp', []);

app.controller('MfgSmallController', function($scope, $http, $filter) {
    ...
    $scope.generateReport = function() {
        ...
        $http.get('GenerateMfgSmallServlet?reportDate=' + formattedDate)
